...
from ...core.features import union_dataframes
...
@add_output_filter()
@fill_nulls()
def reduce_union_dataframes(*args, **kwargs) -> pyspark.sql.DataFrame:
    ...
    wrapper for `union_dataframes`.
    """
    return union_dataframes.reduce_union_dataframes(*args, **kwargs)
