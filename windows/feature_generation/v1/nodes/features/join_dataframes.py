...
from refit.v1.core.remove_debug_columns import remove_output_debug_columns
from refit.v1.core.retry import retry
from refit.v1.core.unpack import unpack_params

from ...core.features import join_dataframes
...
def join_dataframes_with_spine(*args, **kwargs) -> pyspark.sql.DataFrame:
    """See core function for more details.

    Add_input_kwarg_filter, add_input_kwarg_select, has_schema, unpack_params,
    inject_object, retry, add_output_filter, fill_nulls and add_output_primary_key
    wrapper for `join_dataframes`.
    """
    return join_dataframes.join_dataframes_with_spine(*args, **kwargs)
