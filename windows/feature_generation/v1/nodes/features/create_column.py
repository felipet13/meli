...
from ...core.features import create_column
...
@add_output_filter()
@fill_nulls()
def create_columns_from_config(*args, **kwargs) -> pyspark.sql.DataFrame:
    ...
    wrapper for `create_columns_from_config`.
    """
    return create_column.create_columns_from_config(*args, **kwargs)
