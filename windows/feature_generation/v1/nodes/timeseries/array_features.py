...
"""API node for aggregate in timeseries."""
...
from ...core.timeseries import array_features
...
@add_output_filter()
@fill_nulls()
def create_array_features(*args, **kwargs) -> pyspark.sql.DataFrame:
    ...
    `create_aggregations_from_config`.
    """
    return array_features.create_array_features(*args, **kwargs)
