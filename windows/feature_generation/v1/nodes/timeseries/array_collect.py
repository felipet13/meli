...
"""API node for collect in timeseries."""
...
from ...core.timeseries import array_collect
...
@add_output_filter()
@fill_nulls()
def collect_array_then_interpolate(*args, **kwargs) -> pyspark.sql.DataFrame:
    ...
    wrapper for `collect_array_then_interpolate`.
    """
    return array_collect.collect_array_then_interpolate(*args, **kwargs)
